import{p as B}from"./chunk-K2ZEYYM2-CHZIOL0H.js";import{p as U}from"./gitGraph-F2EDSAW4-EHNGVA3B-pLavWGwV.js";import{E as Z,p as q,q as V,s as X,g as Y,d as j,c as H,_ as i,l as C,t as J,e as K,F as Q,a5 as tt,aW as et,aX as z,aY as at,m as rt,aZ as it}from"./md-DDOO1ugQ.js";import"./chunk-TZBO7MLI-BlwIb0Mm.js";import"./monaco/bundled-types-BomO3YJD.js";import"./modules/vue-BY2y9pTo.js";import"./modules/file-saver-igGfcqei.js";import"./lz-string-7V7f_eN4.js";import"./index-CjUswqsu.js";import"./modules/shiki-Ib1F0Tte.js";import"./slidev/default-BKAGt7Xj.js";import"./slidev/context-Cv-l1RMc.js";var F=Z.pie,D={sections:new Map,showData:!1,config:F},m=D.sections,w=D.showData,st=structuredClone(F),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,J()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),W={getConfig:ot,clear:nt,setDiagramTitle:q,getDiagramTitle:V,setAccTitle:X,getAccTitle:Y,setAccDescription:j,getAccDescription:H,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,W)},"parse")},ft=i(t=>`
  .pieCircle{
